...
class CrownThemePalettes
{
    ...
    public static function cssVariables(?string $key): array
    {
        ...
        return [
            ...
            '--crown-charcoal'      => '#374151',
            '--crown-charcoal-soft' => '#4b5563',
            '--crown-sidebar-bg'    => '#ffffff',
            '--crown-sidebar-border'=> '#e5e7eb',
            '--crown-sidebar-text'  => '#374151',
            '--crown-sidebar-hover' => '#f3f4f6',
            '--crown-sidebar-active'=> $palette[50] ?? '#fef2f2',
            '--crown-table-head-bg' => $palette[50] ?? '#f9fafb',
            '--crown-table-head-text' => $palette[800] ?? '#1f2937',
            '--crown-table-foot-bg' => $palette[100] ?? '#f3f4f6',
            '--crown-table-foot-text' => $palette[900] ?? '#111827',
            '--crown-bg'            => '#f4f5f7',
            '--crown-card'          => '#ffffff',
            '--crown-border'        => '#e6e8ec',
            '--crown-grid'          => '#eef0f2',
    ...
    public static function cssVariablesDark(?string $key): array
    {
        ...
        return array_merge(self::cssVariables($key), [
            ...
            '--crown-sidebar-bg'    => '#24262b',
            '--crown-sidebar-border'=> '#3a3d44',
            '--crown-sidebar-text'  => '#e5e7eb',
            '--crown-sidebar-hover' => '#33363d',
            '--crown-sidebar-active'=> '#33363d',
            '--crown-table-head-bg' => '#33363d',
            '--crown-table-head-text' => '#f3f4f6',
            '--crown-table-foot-bg' => '#2b2d33',
            '--crown-table-foot-text' => '#f9fafb',
